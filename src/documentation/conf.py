...
project = "Malleability of Locus of Control by Traumatic Events"
copyright = "2013-, Tobias Raabe and Imke Strampe"  # noqa: A001
...
latex_documents = [
    (
        ...
        "Documentation of the Malleability of Locus of Control by Traumatic "
        "Events project",
