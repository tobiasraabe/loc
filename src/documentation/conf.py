...
project = u"Malleability of Locus of Control by Traumatic Events"
copyright = u"2013-, Tobias Raabe and Imke Strampe"
...
latex_documents = [(
    ...
    "Documentation of the Malleability of Locus of Control by Traumatic Events project",
    "Tobias Raabe and Imke Strampe",
    "manual"
)]
