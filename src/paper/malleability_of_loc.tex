...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{../../bld/out/figures/fig-stated-loc-fa}
...
\begin{table}[H]
	\tiny{\input{../../bld/out/tables/reg_table_1.tex}}
...
\begin{table}[H]
	\tiny{\input{../../bld/out/tables/reg_table_2.tex}}
	\footnotesize \textit{Included controls: education, age, ln(hh income),
	employment status, migration status, gender, marital status; Standard
	errors are clustered on the individual level.}
...
\begin{table}[H]
	\input{../../bld/out/tables/reg_table_3.tex}
	\footnotesize \textit{Included controls: education, age, ln(hh income),
	employment status, migration status, gender, marital status; Standard
	errors are clustered on the individual level.}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{../../bld/out/figures/fig-fa-two-comp-explained-variance}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{../../bld/out/figures/fig-pca-two-comp-explained-variance}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{../../bld/out/figures/fig-fa-factor-loadings}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{../../bld/out/figures/fig-events-count}
...
\input{../../bld/out/tables/tab-panel-descriptive-statistics-any}
\input{../../bld/out/tables/tab-panel-descriptive-statistics-child-disorder}
\input{../../bld/out/tables/tab-panel-descriptive-statistics-death-child}
\input{../../bld/out/tables/tab-panel-descriptive-statistics-death-father}
\input{../../bld/out/tables/tab-panel-descriptive-statistics-death-hh-person}
\input{../../bld/out/tables/tab-panel-descriptive-statistics-death-mother}
\input{../../bld/out/tables/tab-panel-descriptive-statistics-death-partner}
\input{../../bld/out/tables/tab-panel-descriptive-statistics-divorced}
\input{../../bld/out/tables/tab-panel-descriptive-statistics-hh-comp-change}
\input{../../bld/out/tables/tab-panel-descriptive-statistics-last-job-ended}
\input{../../bld/out/tables/tab-panel-descriptive-statistics-last-job-ended-limited}
\input{../../bld/out/tables/tab-panel-descriptive-statistics-legally-handicapped-perc}
\input{../../bld/out/tables/tab-panel-descriptive-statistics-pregnancy-unplanned}
\input{../../bld/out/tables/tab-panel-descriptive-statistics-separated}
